...
public class GeneralCborTpPayload implements ISawtoothWritePayload {

    private static final Logger LOG = Logger.getLogger(GeneralCborTpPayload.class);
    ...
    public List<String> getInputAddresses(final String... params) {
        return TpHandler.getTpInputWrite(Configuration.TP_ENUM, Configuration.TP_PREFIX,
                Arrays.asList(params));
    }

    @Override
    public List<String> getOutputAddresses(final String... params) {
        return TpHandler.getTpOutputWrite(Configuration.TP_ENUM, Configuration.TP_PREFIX,
                Arrays.asList(params));
    }
