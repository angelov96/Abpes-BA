...
public class GeneralCborTpSbPayload implements ISawtoothWritePayload {

    private static final Logger LOG = Logger.getLogger(GeneralCborTpSbPayload.class);
    ...
    public List<String> getInputAddresses(final String... params) {
        if("DepositChecking".equals(function)) {
            return TpSbHandler.getTpInputWrite(Configuration.TP_ENUM, Configuration.TP_PREFIX,
                    Arrays.asList(params), function);
        }
        else if("WriteCheck".equals(function)) {
            return TpSbHandler.getTpInputWrite(Configuration.TP_ENUM, Configuration.TP_PREFIX,
                    Arrays.asList(params), function);
        }
    ...
    public List<String> getOutputAddresses(final String... params) {
        if("CreateAccount".equals(function)) {
            return TpSbHandler.getTpOutputWrite(Configuration.TP_ENUM, Configuration.TP_PREFIX,
                    Arrays.asList(params), function);
        }
