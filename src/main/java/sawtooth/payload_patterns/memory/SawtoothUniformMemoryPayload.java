package sawtooth.payload_patterns.memory;
...
public class SawtoothUniformMemoryPayload implements ISawtoothPayloads {

    private static final Logger LOG = Logger.getLogger(SawtoothUniformMemoryPayload.class);
    ...
    private ImmutablePair<Object[], String> createPayload(final ClientObject clientObject, final int i,
        ...
        iSawtoothWritePayload.setFamilyName("memory");
        iSawtoothWritePayload.setFamilyVersion("0.1");
        iSawtoothWritePayload.setEventPrefix("memory ");
        iSawtoothWritePayload.setSpecificPayloadType("memory");
