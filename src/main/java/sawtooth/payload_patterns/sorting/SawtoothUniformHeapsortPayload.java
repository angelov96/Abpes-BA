...
public class SawtoothUniformHeapsortPayload implements ISawtoothPayloads {

    private static final Logger LOG = Logger.getLogger(SawtoothUniformHeapsortPayload.class);
    ...
    private ImmutablePair<Object[], String> createPayload(final ClientObject clientObject, final int i,
        ...
        iSawtoothWritePayload.setFamilyName("heapSort");
        iSawtoothWritePayload.setFamilyVersion("0.1");
        iSawtoothWritePayload.setEventPrefix("sort/heapSort ");
        iSawtoothWritePayload.setSpecificPayloadType("sort/heapSort");
