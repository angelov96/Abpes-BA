...
public class SawtoothUniformQuicksortPayload implements ISawtoothPayloads {

    private static final Logger LOG = Logger.getLogger(SawtoothUniformQuicksortPayload.class);
    ...
    private ImmutablePair<Object[], String> createPayload(final ClientObject clientObject, final int i,
        ...
        iSawtoothWritePayload.setFamilyName("quickSortRec");
        iSawtoothWritePayload.setFamilyVersion("0.1");
        iSawtoothWritePayload.setEventPrefix("sort/quickSortRec ");
        iSawtoothWritePayload.setSpecificPayloadType("sort/quickSortRec");
