...
import com.heapsortflow.flows.HeapSortFlow;
...
public class CordaUniformHeapsortPayload implements ICordaPayloads {

    private static final Logger LOG = Logger.getLogger(CordaUniformHeapsortPayload.class);
    ...
    private ImmutablePair<List<Object>, String> createPayload(final CordaRPCOps proxy,
        ...
        iCordaWritePayload.setEventPrefix("sort/heapSort ");
        iCordaWritePayload.setSpecificPayloadType("sort/heapSort");
