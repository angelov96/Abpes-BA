...
import com.quicksortrecflow.flows.QuickSortRecFlow;
...
public class CordaUniformQuicksortPayload implements ICordaPayloads {

    private static final Logger LOG = Logger.getLogger(CordaUniformQuicksortPayload.class);
    ...
    private ImmutablePair<List<Object>, String> createPayload(final CordaRPCOps proxy,
        ...
        values.add(QuickSortRecFlow.class);
        values.add("Sort");
        ...
        iCordaWritePayload.setEventPrefix("sort/quickSortRec ");
        iCordaWritePayload.setSpecificPayloadType("sort/quickSortRec");
