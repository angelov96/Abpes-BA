...
public class CordaUniformIOScanPayload implements ICordaPayloads {

    private static final Logger LOG = Logger.getLogger(CordaUniformIOScanPayload.class);
    ...
    private ImmutablePair<List<Object>, String> createPayload(final CordaRPCOps proxy,
        ...
        iCordaWritePayload.setEventPrefix("storage/scan ");
        iCordaWritePayload.setSpecificPayloadType("storage/scan");
