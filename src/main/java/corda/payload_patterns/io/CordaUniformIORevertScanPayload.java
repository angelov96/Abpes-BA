...
public class CordaUniformIORevertScanPayload implements ICordaPayloads {

    private static final Logger LOG = Logger.getLogger(CordaUniformIORevertScanPayload.class);
    ...
    private ImmutablePair<List<Object>, String> createPayload(final CordaRPCOps proxy,
        ...
        iCordaWritePayload.setEventPrefix("storage/revertScan ");
        iCordaWritePayload.setSpecificPayloadType("storage/revertScan");
