package corda.payload_patterns.donothing;
...
import com.donothingflow.flows.DoNothingFlow;
...
public class CordaUniformDoNothingPayload implements ICordaPayloads {

    private static final Logger LOG = Logger.getLogger(CordaUniformDoNothingPayload.class);
    ...
    private ImmutablePair<List<Object>, String> createPayload(final CordaRPCOps proxy,
        ...
        values.add(DoNothingFlow.class);
        values.add(null);
        ...
        iCordaWritePayload.setEventPrefix("doNothing ");
        iCordaWritePayload.setSpecificPayloadType("doNothing");
