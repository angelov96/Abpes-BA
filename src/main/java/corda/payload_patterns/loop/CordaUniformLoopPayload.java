package corda.payload_patterns.loop;
...
import com.loopflow.flows.LoopFlow;
...
public class CordaUniformLoopPayload implements ICordaPayloads {

    private static final Logger LOG = Logger.getLogger(CordaUniformLoopPayload.class);
    ...
    private ImmutablePair<List<Object>, String> createPayload(final CordaRPCOps proxy,
        ...
        iCordaWritePayload.setEventPrefix("loop ");
        iCordaWritePayload.setSpecificPayloadType("loop");
