...
public class CordaUniformSbCreateAccountPayload implements ICordaPayloads {

    private static final Logger LOG = Logger.getLogger(CordaUniformSbCreateAccountPayload.class);
    ...
    private ImmutablePair<List<Object>, String> createPayload(final CordaRPCOps proxy,
        ...
        iCordaWritePayload.setEventPrefix("createAccount ");
        iCordaWritePayload.setSpecificPayloadType("createAccount");
