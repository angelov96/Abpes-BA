...
public class CordaUniformSbWriteCheckPayload implements ICordaPayloads {

    private static final Logger LOG = Logger.getLogger(CordaUniformSbWriteCheckPayload.class);
    ...
    private ImmutablePair<List<Object>, String> createPayload(final CordaRPCOps proxy,
        ...
        iCordaWritePayload.setEventPrefix("writeCheck ");
        iCordaWritePayload.setSpecificPayloadType("writeCheck");
