...
public class CordaUniformSbAmalgamatePayload implements ICordaPayloads {

    private static final Logger LOG = Logger.getLogger(CordaUniformSbAmalgamatePayload.class);
    ...
    private ImmutablePair<List<Object>, String> createPayload(final CordaRPCOps proxy,
        ...
        iCordaWritePayload.setEventPrefix("amalgamate ");
        iCordaWritePayload.setSpecificPayloadType("amalgamate");
