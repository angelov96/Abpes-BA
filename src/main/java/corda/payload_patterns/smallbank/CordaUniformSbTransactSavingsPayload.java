...
public class CordaUniformSbTransactSavingsPayload implements ICordaPayloads {

    private static final Logger LOG = Logger.getLogger(CordaUniformSbTransactSavingsPayload.class);
    ...
    private ImmutablePair<List<Object>, String> createPayload(final CordaRPCOps proxy,
        ...
        iCordaWritePayload.setEventPrefix("transactSavings ");
        iCordaWritePayload.setSpecificPayloadType("transactSavings");
