...
public class CordaUniformSbBalancePayload implements ICordaPayloads {

    private static final Logger LOG = Logger.getLogger(CordaUniformSbBalancePayload.class);
    ...
    private ImmutablePair<List<Object>, String> createPayload(final CordaRPCOps proxy,
        ...
        iCordaWritePayload.setEventPrefix("balance ");
        iCordaWritePayload.setSpecificPayloadType("balance");
