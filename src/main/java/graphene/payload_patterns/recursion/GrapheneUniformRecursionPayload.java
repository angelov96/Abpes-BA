package graphene.payload_patterns.recursion;
...
public class GrapheneUniformRecursionPayload implements IGraphenePayloads {

    private static final Logger LOG = Logger.getLogger(GrapheneUniformRecursionPayload.class);
    ...
    private ImmutablePair<Object[], String> createPayload(final ClientObject clientObject, final String acctId,
        ...
        int operationId = OperationType.RECURSION_OPERATION.ordinal();
        ...
        iGrapheneWritePayload.setEventPrefix("recursion ");
        iGrapheneWritePayload.setSpecificPayloadType("recursion");
