...
public class GrapheneUniformQuicksortPayload implements IGraphenePayloads {

    private static final Logger LOG = Logger.getLogger(GrapheneUniformQuicksortPayload.class);
    ...
    private ImmutablePair<Object[], String> createPayload(final ClientObject clientObject, final String acctId,
        ...
        int operationId = OperationType.QUICKSORTREC_OPERATION.ordinal();
        ...
        iGrapheneWritePayload.setEventPrefix("sort/quicksortRec ");
        iGrapheneWritePayload.setSpecificPayloadType("sort/quicksortRec");
