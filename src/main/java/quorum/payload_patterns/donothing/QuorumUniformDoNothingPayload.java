package quorum.payload_patterns.donothing;
...
public class QuorumUniformDoNothingPayload implements IQuorumPayloads {

    private static final Logger LOG = Logger.getLogger(QuorumUniformDoNothingPayload.class);
    ...
    private ImmutablePair<Object[], String> createPayload(final ClientObject clientObject, final int i,
        ...
        iQuorumWritePayload.setEventPrefix("doNothing");
        iQuorumWritePayload.setSpecificPayloadType("doNothing");
