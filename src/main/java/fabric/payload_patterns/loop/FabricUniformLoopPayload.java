package fabric.payload_patterns.loop;
...
public class FabricUniformLoopPayload implements IFabricPayloads {

    private static final Logger LOG = Logger.getLogger(FabricUniformLoopPayload.class);
    ...
    private ImmutablePair<Object[], String> createPayload(final ClientObject clientObject, final int i,
        ...
        iFabricWritePayload.setEventPrefix("loop ");
        iFabricWritePayload.setSpecificPayloadType("loop");
