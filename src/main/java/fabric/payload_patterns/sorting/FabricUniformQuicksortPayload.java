...
public class FabricUniformQuicksortPayload implements IFabricPayloads {

    private static final Logger LOG = Logger.getLogger(FabricUniformQuicksortPayload.class);
    ...
    private ImmutablePair<Object[], String> createPayload(final ClientObject clientObject, final int i,
        ...
        iFabricWritePayload.setEventPrefix("sort/quickSortRec ");
        iFabricWritePayload.setSpecificPayloadType("sort/quickSortRec");
