package fabric.payload_patterns.recursion;
...
public class FabricUniformRecursionPayload implements IFabricPayloads {

    private static final Logger LOG = Logger.getLogger(FabricUniformRecursionPayload.class);
    ...
    private ImmutablePair<Object[], String> createPayload(final ClientObject clientObject, final int i,
        ...
        iFabricWritePayload.setEventPrefix("recursion ");
        iFabricWritePayload.setSpecificPayloadType("recursion");
