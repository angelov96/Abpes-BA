...
public final class TraitHelpers {
    ...
    static java.util.List<TransactionArgument> deserialize_vectorf_TransactionArgument(com.novi.serde.Deserializer deserializer) throws com.novi.serde.DeserializationError {
        long length = deserializer.deserialize_len();
